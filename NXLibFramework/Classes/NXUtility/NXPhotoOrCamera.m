...
- (void)showActionSheetWithController:(UIViewController *)controller
{
    ...
    NXActionSheet *actionSheet = [[NXActionSheet alloc] initWithTitle:@"选择图片"
                                                             delegate:self
...
- (void)showImagePickerWithAnimation:(BOOL)hasAnimation sourceType:(UIImagePickerControllerSourceType)type
{
    ...
    if (version >= 7.0)
    {
        //        UIImage *backgroundImage = [UIImage imageNamed:@"bg_navigationbar_ios7_h.png"];
        //                    [imagePickerController.navigationBar setBackgroundImage:backgroundImage
    ...
    {
        //        UIImage *backgroundImage = [UIImage imageNamed:@"btn_navigationbar_h.png"];
        //        [imagePickerController.navigationBar setBackgroundImage:backgroundImage
        //        forBarMetrics:UIBarMetricsDefault];
        //                    [imagePickerController.navigationBar setBackgroundColor:[UIColor blackColor]];
                    ...
                    animated:(BOOL)animated
{
    ...
    {
        //隐藏tab
//        [showController.rootDelegate.tabBar setTabBarHidden:YES animated:NO];
