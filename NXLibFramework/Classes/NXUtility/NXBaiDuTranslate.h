...
typedef void (^translateCompleteSuccess)(NXBaiDuTranslate *operation,
                                         id responseObject);

typedef void (^translateCompleteFailure)(NXBaiDuTranslate *operation,
                                         NSError *error);
...
- (void)translateWithQuery:(NSString *)translateStr
                   success:(void (^)(NXBaiDuTranslate *operation,
                                     id responseObject))success
                   failure:(void (^)(NXBaiDuTranslate *operation,
