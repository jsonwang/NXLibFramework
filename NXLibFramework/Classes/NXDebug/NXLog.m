                   ...
                   NSString *methodName)
{
    ...
    if (xcode_colors && (strcmp(xcode_colors, "YES") == 0))
    {
        ...
        // lastPathComponent] UTF8String],LINE, [[NSString stringWithFormat:FORMAT, ##VA_ARGS] UTF8String]);
        NSLog(@"%@",
    ...
    {
        NSLog(@"XcodeColors 没有安装 https://github.com/jsonwang/XcodeColors#option-1-manual-use--custom-macros");
