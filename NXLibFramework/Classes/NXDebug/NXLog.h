...
//#define NXDEVELOPMENT_ENVIRONMENT
  ...
  注意XXXX 如果 定义了 NXDEVELOPMENT_ENVIRONMENT 这个宏 就打印LOG 在relese 时注意关闭LOG
 ...
 */
void NXLogMessagev(NXLogLevel logLevel, NSString *format, va_list args, NSString *fileName, NSUInteger lineNumber, NSString *methodName);
