...
/**
 ...
 Results are cached and therefore a subsequent call for the same receiver will return instantly if the result is still
...
/** Returns the URL to open the mobile app store on the app's page.
 ...
 URL construction as described in [QA1629](https://developer.apple.com/library/ios/#qa/qa2008/qa1629.html). Test and
 found to be opening the app store app directly even without the itms: or itms-apps: scheme. This kind of URL can also
