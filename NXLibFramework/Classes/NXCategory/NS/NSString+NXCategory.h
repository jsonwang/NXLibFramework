...
/**
 Method to get the recommended MIME-Type for the given file extension. If no MIME-Type can be determined then
...
/**
 *  URL编码 @see https://developer.apple.com/library/mac/documentation/CoreFoundation/Reference/CFURLRef/
...
/*
   e.g.
     ...
     NSLog(@"base64加密:%@----%@",[msg nx_base64Encoded],[[msg nx_base64Encoded] nx_base64Decoded]);
