...
/*
 ...
 [setArray_f addObject:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor blackColor],@"Color",[UIFont
 systemFontOfSize:14],@"Font",nil]];

 [setArray_f addObject:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor blueColor],@"Color",[UIFont
 systemFontOfSize:14],@"Font",nil]];

 MultiTextView* showLable = [[MultiTextView alloc] initWithFrame:CGRectMake(init_x,init_y,320,30)];
